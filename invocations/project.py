...
def update(
    context: invoke.Context,
    poetry_params: str = "--no-install",
) -> None:
    """Update project dependencies."""
    saritasa_invocations.poetry.update_to_latest(context, params=poetry_params)
    saritasa_invocations.pre_commit.update(context)
...
def init_from_scratch(
    ...
    saritasa_invocations.print_success(
        ...
        "\n- Remove `init_from_scratch` task;"
        "\n- Update CODEOWNERS;"
        "\n- Update README.md with data about project;"
        "\n- Update CHANGELOG.md;"
        "\n- Add links to ENVIRONMENT.md;",
    )
