...
ENDPOINTS_TO_FILTER_OUT = [
    # Motivation:
    # These endpoints are called often by AWS EC2 target group checker or via
    # k8s checker, so it sends a lot of data to sentry,
    # while these endpoints actually does nothing
    "livez",
    "readyz",
    "healthz",
]
